...
def start(update, context):
    context.bot.send_message(chat_id=update.effective_chat.id, text = "Bonjour {}, je suis le bot de WeLearn, vous pouvez m'appelez Maya je suis là pour vous servir. Dites moi ce que vous désirez, il vous suffit de choisir une commande dans la liste des commandes disponibles", format(update.from_user.first_name))
